package com.hedgehog.common.pasing;

public class Pagenation {

    public static SelectProduct getSelectProduct(int pageNo, int totalCount, int limit, int buttonAmount) {
...
//		startPage = (((int)((double) pageNo / buttonAmount + 0.9)) - 1) * buttonAmount + 1;
        ...
        SelectProduct SelectProduct = new SelectProduct(pageNo, totalCount, limit, buttonAmount ,maxPage, startPage, endPage, startRow, endRow);
