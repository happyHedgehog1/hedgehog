...
$("body").on("click", "#btnCategoryAdd", function(event) {
    ...
    var newCategory = $(
        ...
        "<tr class='category'>" +
        "<td><img src='/admin/images/category1.png' height='20px'> 카테고리(대분류)</td>" +
        "<td><a href='#'><img src='/admin/images/add2.png' height='13px' name='img-add2' style='padding-left: 5px;'></a></td>" +
        "<td><a href='#'><img src='/admin/images/open.png' height='12px' name='img-open' id='img-open'></a></td>" +
        "<td><a href='#'><img src='/admin/images/allow_down.png' height='10px' name='img-allow_down'></a></td>" +
        "</tr>"
    );
...
$("body").on("click", 'img[name="img-add2"]', function() {
    ...
    var newsemiCategory = $(
        ...
        "<td></td>"+
        "<td></td>"+
        "<td><a href='#'><img src='/admin/images/open.png' height='12px' name='open'></a></td>"+
        "</tr>"
    );
...
function toggleImageState(clickedImage) {
    ...
    switch (imageName) {
        ...
        case 'img-allow_up':
            ...
            break;
        case 'img-close':
            clickedImage.attr('src', '/admin/images/open.png');
            clickedImage.attr('name', 'img-open');
            break;
        case 'img-open':
            clickedImage.attr('src', '/admin/images/close.png');
