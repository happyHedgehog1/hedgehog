$(document).ready(function(){
    ...
    $('#email_button').click(function () {
        ...
        if (isValid) {
            $.ajax({
                url: "/auth/searchPassword/checkEmail",
                method: "POST",
                ...
                success: function (result) {
                    if (result.result === "success") {
                        ...
                        location.href="/auth/searchPassword";
                    }
                    else {
                        $('#email_button').css('display', '');
            ...
            $('#input_email').prop('readonly', false);
            $('#userId').prop('readonly', false);
            $('#email_message').html('이메일 또는 아이디 규칙에 맞지 않습니다.<br>다시시도해주세요.');
        }
    })
    ...
    $('#email_authentication_button').click(function () {
        ...
        $.ajax({
            url: "/auth/searchPassword/emailCertify",
            method: "POST",
